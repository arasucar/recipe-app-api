...
def create_recipe(user, **params):
    """Crate and return a sample recipe."""
    defaults = {
...
class PrivateRecipeAPITests(TestCase):
    ...
    def setUp(self):
        self.client = APIClient()
        self.user = create_user(email='user@example.com', password='test1123')
    ...
    def test_full_update(self):
        ...
        payload = {
            ...
            'description': 'Mew recipe description',
            'time_minutes': 10,
            'price': Decimal('2.50')
        }
    ...
    def test_filter_by_tags(self):
        ...
        s1 = serializers.RecipeSerializer(r1)
        s2 = serializers.RecipeSerializer(r2)
        s3 = serializers.RecipeSerializer(r3)
